...
if (isset($_POST['post_apply'])) {
	if($user == ''){
		...
		$result = mysqli_query($con, "INSERT INTO record (`post_id`,`post_by`,`applied_by`,`applied_to`) VALUES ('".$pstid."','".$postby_id."','".$user."','".$postby_id."')");
...
<div>
	<div>
		...
		<div class="topnav">
			...
			<a class="active navlink" href="index.php" style="margin: 0px 0px 0px 100px;">DashBoard Inforfation</a>
		...
		<div class="nfeedleft">
				...
				<?php
					...
					while ($row = $query->fetch_assoc()) {
						...
						$p_university = $row['prefer_uni_teacher'];
						$post_time = $row['post_time'];
						$deadline = $row['deadline'];
						$medium = $row['medium'];

						$query1 = $con->query("SELECT * FROM registration WHERE id='$postby_id'");
